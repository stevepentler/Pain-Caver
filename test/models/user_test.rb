...
class UserTest < ActiveSupport::TestCase
  ...
  test 'auth hash' do 
    assert_difference 'User.count', 1 do 
      ...
      assert_equal "[{:id=>\"g1261219\", :primary=>false, :name=>\"ASICS Gel Nimbus 17 Asics\", :resource_state=>2, :distance=>42449.0}, {:id=>\"g1261218\", :primary=>true, :name=>\"Saucony Peregrine Peregrine 4\", :resource_state=>2, :distance=>80085.0}]", user.shoes
